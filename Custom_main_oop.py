...
class App(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.state('zoomed')
        self.title = ctk.CTkLabel(self, text='CERTIFLY', font=headFont) # Setting title & tagline
        self.tagline = ctk.CTkLabel(self, text='Certificates on the Go', font=normalFont)
        self.mode_switch_button = ctk.CTkButton(self, image=self.light_mode_img, text="", height=40, width=40, corner_radius=10, fg_color="transparent", command=self.mode_switcher)
        ...
        self.name_button = ctk.CTkButton(self.sideFrame, text="Enter names", font=normalFont, command=self.enter_names) # button to enter the names
        self.open_button = ctk.CTkButton(self.sideFrame, text="Open Image", font=normalFont, command=self.open_image) #  button to open an image file
        self.gen_sample_button = ctk.CTkButton(self.sideFrame, text="Generate Sample", font=normalFont, command=self.generate_sample) #  button to open an image file
        self.gen_all_button = ctk.CTkButton(self.sideFrame, text="Generate All",font=normalFont, command=self.generate_all) #  button to open an image file
        ...
        self.canvas = ctk.CTkCanvas(self.canvasFrame, width=910, height=650, bd=0, highlightthickness=0) # canvas to display the image #1280, 904
